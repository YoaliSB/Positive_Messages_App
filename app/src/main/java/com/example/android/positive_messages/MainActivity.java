package com.example.android.positive_messages;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Switch toggle =  findViewById(R.id.daynight);
    ...
    public void random(View view){
        counter = (int) (Math.random()  * LIST.length);
    ...
    public void last(View view){
        int temp = --counter;
        counter = temp < 0 ? LIST.length-1 : temp;
        Log.d(TAG, ""+counter);
        textView.setText(LIST[counter]);
    }
